...
public class LocalFileOffsetStore implements OffsetStore {
  /**
   * 消息进度存储目录，可以通过：<code>Drocketmq.client.localOffsetStoreDir</code> 指定，如果未指定，则默认 为：<code>
   *  用户主目录 /.rocketmq_offsets</code>
   */
  public static final String LOCAL_OFFSET_STORE_DIR =
      System.getProperty(
  ...
  public void load() throws MQClientException {
    // 从 storePath 中尝试加载内容，如果读取的内容为空，尝试从 storePath+".bak" 中加载，如果还是未找到内容，则返回 null
    ...
    if (offsetSerializeWrapper != null && offsetSerializeWrapper.getOffsetTable() != null) {
      ...
      for (Entry<MessageQueue, AtomicLong> mqEntry :
        ...
        log.info(
            "load consumer's offset, {} {} {}", this.groupName, mqEntry.getKey(), offset.get());
      }
    }
  }
  ...
  public void updateConsumeOffsetToBroker(
      final MessageQueue mq, final long offset, final boolean isOneway)
