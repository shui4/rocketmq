...
public class DefaultMQProducerImpl implements MQProducerInner {
  ...
  private final ArrayList<EndTransactionHook> endTransactionHookList =
      new ArrayList<EndTransactionHook>();
  ...
  private ArrayList<CheckForbiddenHook> checkForbiddenHookList =
      new ArrayList<CheckForbiddenHook>();
  ...
  public void registerCheckForbiddenHook(CheckForbiddenHook checkForbiddenHook) {
    ...
    log.info(
        "register a new checkForbiddenHook. hookName={}, allHookSize={}",
        checkForbiddenHook.hookName(),
  ...
  /**
   * @deprecated This method will be removed in the version 5.0.0 and {@link
   *     DefaultMQProducerImpl#getCheckListener} is recommended.
   */
  @Override
  @Deprecated
            ...
            if (transactionCheckListener != null || transactionListener != null) {
              ...
              try {
                if (transactionCheckListener != null) {
                  ...
                  log.warn(
                      "CheckTransactionState, pick transactionListener by group[{}] failed", group);
                }
              } catch (Throwable e) {
                log.error(
          ...
          private void processTransactionState(
            ...
            switch (localTransactionState) {
              ...
              case UNKNOW:
                ...
                log.warn(
                    "when broker check, client does not know this transaction state, {}",
                    thisHeader);
                break;
              default:
                break;
          ...
          // ?  发送消息出现异常
            ...
            log.warn(
                String.format(
                    ...
                    invokeID, endTimestamp - beginTimestampPrev, mq),
                e);
  ...
  private SendResult sendKernelImpl(
    ...
    // 如果从MQClientInstance的brokerAddrTable中未缓存该Broker的信息，则从NameServer主动更新topic的路由信息。
    // 如果路由更新后还在找不到Broker信息，则抛出MQClientException，提示Broker不存在
    if (null == brokerAddr) {
    ...
    if (brokerAddr != null) {
      brokerAddr =
          MixAll.brokerVIPChannel(this.defaultMQProducer.isSendMessageWithVIPChannel(), brokerAddr);
      ...
      try {
        ...
        // 如果消息体默认超过4KB（compressMsgBody-OverHowMuch），则对消息采用zip压缩，并设置消息的系统标记为MessageSysFlag.COMPRESSED_FLAG。
        int sysFlag = 0;
        ...
        // 代码清单3-23
        // 如果注册了消息发送钩子函数，则执行消息发送之前的增强逻辑。通过registerSendMessageHook注册钩子处理类，并且可以注册多个
        if (this.hasSendMessageHook()) {
          ...
          // 如果事物Prepared消息，则设置消息的系统标记为MessageSysFlag.TRANSACTION_PREPARED_TYPE
        ...
        // 代码清单3-27
        // 如果注册了消息发送钩子函数，则执行after逻辑。注意，就算消息发送过程中发生RemotingException、MQBrokerException、InterruptedException操作，该方法也会执行
        if (this.hasSendMessageHook()) {
  ...
  public void doExecuteEndTransactionHook(
      Message msg,
      String msgId,
      String brokerAddr,
  ...
  public void sendOneway(Message msg)
    ...
    try {
      this.sendDefaultImpl(
          msg, CommunicationMode.ONEWAY, null, this.defaultMQProducer.getSendMsgTimeout());
    } catch (MQBrokerException e) {
  ...
  @Deprecated
  public void send(
      final Message msg, final MessageQueue mq, final SendCallback sendCallback, final long timeout)
      throws MQClientException, RemotingException, InterruptedException {
    final long beginStartTime = System.currentTimeMillis();
    ExecutorService executor = this.getAsyncSenderExecutor();
    try {
            ...
            public void run() {
              try {
                ...
                if (timeout > costTime) {
                  try {
                    sendKernelImpl(
                        msg, mq, CommunicationMode.ASYNC, sendCallback, null, timeout - costTime);
                  } catch (MQBrokerException e) {
                    throw new MQClientException("unknown exception", e);
                  }
                } else {
  ...
  private SendResult sendSelectImpl(
    ...
    if (topicPublishInfo != null && topicPublishInfo.ok()) {
      ...
      try {
        ...
        String userTopic =
            NamespaceUtil.withoutNamespace(
                userMessage.getTopic(), mQClientFactory.getClientConfig().getNamespace());
      ...
      if (mq != null) {
        return this.sendKernelImpl(
            msg, mq, communicationMode, sendCallback, null, timeout - costTime);
      } else {
  ...
  /**
   * It will be removed at 4.4.0 cause for exception handling and the wrong Semantics of timeout. A
   * new one will be provided in next version
   *
   * @param msg
   * @param selector
   * @param arg
  ...
  public TransactionSendResult sendMessageInTransaction(
      final Message msg, final LocalTransactionExecuter localTransactionExecuter, final Object arg)
      throws MQClientException {
    TransactionListener transactionListener = getCheckListener();
    ...
    MessageAccessor.putProperty(
        msg, MessageConst.PROPERTY_PRODUCER_GROUP, this.defaultMQProducer.getProducerGroup());
    try {
  ...
  public void endTransaction(
    ...
    final String brokerAddr =
        this.mQClientFactory.findBrokerAddressInPublish(
    ...
    doExecuteEndTransactionHook(
        msg, sendResult.getMsgId(), brokerAddr, localTransactionState, false);
    requestHeader.setProducerGroup(this.defaultMQProducer.getProducerGroup());
    ...
    this.mQClientFactory
        ...
        .endTransactionOneway(
            brokerAddr, requestHeader, remark, this.defaultMQProducer.getSendMsgTimeout());
  }
  ...
  public Message request(Message msg, long timeout)
    ...
    try {
      ...
      RequestFutureHolder.getInstance()
          .getRequestFutureTable()
          .put(correlationId, requestResponseFuture);
  ...
  public Message request(
      final Message msg, final MessageQueueSelector selector, final Object arg, final long timeout)
      throws MQClientException, RemotingException, MQBrokerException, InterruptedException,
  ...
  private Message waitResponse(
      Message msg, long timeout, RequestResponseFuture requestResponseFuture, long cost)
  ...
  public void request(
      final Message msg, final MessageQueue mq, final RequestCallback requestCallback, long timeout)
      throws RemotingException, InterruptedException, MQClientException, MQBrokerException {
    long beginTimestamp = System.currentTimeMillis();
    prepareSendRequest(msg, timeout);
    final String correlationId = msg.getProperty(MessageConst.PROPERTY_CORRELATION_ID);
  ...
  private void requestFail(final String correlationId) {
    RequestResponseFuture responseFuture =
        RequestFutureHolder.getInstance().getRequestFutureTable().remove(correlationId);
  ...
  private void prepareSendRequest(final Message msg, long timeout) {
    ...
    MessageAccessor.putProperty(
        msg, MessageConst.PROPERTY_MESSAGE_REPLY_TO_CLIENT, requestClientId);
    MessageAccessor.putProperty(msg, MessageConst.PROPERTY_MESSAGE_TTL, String.valueOf(timeout));

    boolean hasRouteData =
        this.getmQClientFactory().getTopicRouteTable().containsKey(msg.getTopic());
    if (!hasRouteData) {
      long beginTimestamp = System.currentTimeMillis();
