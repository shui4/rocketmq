...
public class MessageStoreConfig {
  ...
  @ImportantField private int maxTransferCountOnMessageInMemory = 32;
  ...
  @ImportantField private boolean messageIndexSafe = false;
  private int haListenPort = 10912;
  private int haSendHeartbeatInterval = 1000 * 5;
  private int haHousekeepingInterval = 1000 * 20;
  private int haTransferBatchSize = 1024 * 32;
  @ImportantField private String haMasterAddress = null;
  private int haSlaveFallbehindMax = 1024 * 1024 * 256;
  @ImportantField private BrokerRole brokerRole = BrokerRole.ASYNC_MASTER;
  @ImportantField private FlushDiskType flushDiskType = FlushDiskType.ASYNC_FLUSH;
  private int syncFlushTimeout = 1000 * 5;
  private int slaveTimeout = 3000;
  private String messageDelayLevel = "1s 5s 10s 30s 1m 2m 3m 4m 5m 6m 7m 8m 9m 10m 20m 30m 1h 2h";
  private long flushDelayOffsetInterval = 1000 * 10;
  @ImportantField private boolean cleanFileForciblyEnable = true;
  ...
  /** ? 临时存储池启用 */
  @ImportantField private boolean transientStorePoolEnable = false;
  ...
  public int getMappedFileSizeConsumeQueue() {
    ...
    int factor =
        (int) Math.ceil(this.mappedFileSizeConsumeQueue / (ConsumeQueue.CQ_STORE_UNIT_SIZE * 1.0));
  ...
  /**
   * Enable transient commitLog store pool only if transientStorePoolEnable is true and the
   * FlushDiskType is ASYNC_FLUSH
   *
  ...
  public void setScheduleAsyncDeliverMaxResendNum2Blocked(
      int scheduleAsyncDeliverMaxResendNum2Blocked) {
